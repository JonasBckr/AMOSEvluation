...
fold_subdir = "/data/miscnn_models/model0109"
...
cross_validation(sample_list, model, epochs=500, iterations=150, k_fold=3,
                 draw_figures=True, evaluation_path="/data/miscnn_models/model0109", run_detailed_evaluation=True, callbacks=[cb_lr, cb_es, cb_tb, cb_cl, cb_mc])
